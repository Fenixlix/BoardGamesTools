...
public class CrapsGame {
    ...
    public Pair<Integer, Integer> takeTurn(){
        Pair<Integer, Integer> dices = tossDice();
    ...
    @NonNull
    private Pair<Integer, Integer> tossDice(){
    ...
    private int sumDices(@NonNull Pair<Integer, Integer> dices){
